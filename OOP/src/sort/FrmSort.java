...
public class FrmSort extends JFrame {
	...
	public FrmSort() {
		...
		contentPane.setBackground(new Color(248, 205, 180));
		...
		toolbar.setBackground(new Color(248, 205, 180));
		...
		btnAdd.setBackground(new Color(239, 163, 116));
		toolbar.add(btnAdd);
		...
		btnSort.setBackground(new Color(239, 163, 116));
		toolbar.add(btnSort);
	}
